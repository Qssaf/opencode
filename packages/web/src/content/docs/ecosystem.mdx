...
| [opencode-google-antigravity-auth](https://github.com/Qssaf/opencode-antigravity-auth-desktop)   | Google Antigravity OAuth Plugin, with support for Google Search, and more robust API handling      |
